...
class Mt():
    ...
    def load_images(self):
        self.dragon = pygame.image.load('../../../pygame/data/images/Dargon/dragon.png').convert_alpha()
        self.a1 = pygame.image.load('../../../pygame/data/images/Dargon/1.png').convert_alpha()
        self.a2 = pygame.image.load('../../../pygame/data/images/Dargon/2.png').convert_alpha()
